...
export const formatApiError = (error) => {
  ...
  if (error) {
    ...
    statusCode = error.status || (error.data && error.data.status_code) || (error.response && error.response.status);
 ...
 */
export const handleApiError = (error, setError, setLoading, onLogout = null) => {
...
/**
 * Create a toast notification for an API error
 * @param {Error} error - The error from API call
